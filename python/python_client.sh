...
OTEL_EXPORTER_OTLP_LOGS_ENDPOINT="http://otel-collector-collector.opentelemetry-operator-system.svc:4317" \
...
OTEL_SERVICE_NAME="python-client" \
OTEL_PYTHON_SERVICE_NAME="python-client" \
OTEL_LOG_LEVEL=info \
opentelemetry-instrument python3 ./flask-client.py
